...
class AlarmPin: NSManagedObject, MKAnnotation {
    ...
    convenience init(alarmName: String, longitude: Double, latitude: Double, radius: Double, context: NSManagedObjectContext = Stack.sharedStack.managedObjectContext) {
